...
class DjangoApi {
  static Future<User?> createUser(String email, String password,
    ...
    final response = await post(
      Uri.parse(
          'https://musicappbackendnischal-production.up.railway.app/api=create_user/'),
      body: jsonEncode({
        "username": email,
        "email": email,
        "password": password,
  ...
  static Future<User?> loginWithEmailAndPassword(
    ...
    final response = await post(
      Uri.parse(
          'https://musicappbackendnischal-production.up.railway.app/api=signin/'),
      body: jsonEncode({
        "username": email,
        "email": email,
        "password": password,
  ...
  static Future<User?> resetPassword(String email, String newPassword) async {
    final response = await post(
      Uri.parse(
          'https://musicappbackendnischal-production.up.railway.app/api=forgot_password/'),
      body: jsonEncode({
        "email": email,
  ...
  static Future<String?> signout() async {
    final response = await get(Uri.parse(
        'https://musicappbackendnischal-production.up.railway.app/api=signout/'));
    if (response.statusCode >= 400) return null;
    return 'Successful';
  }
  ...
  static Future<List<Map<String, dynamic>?>?> getFeedbacks(int postId) async {
    final response = await get(Uri.parse(
        'https://musicappbackendnischal-production.up.railway.app/api=feedback/'));
  ...
  static Future<String?> getMusic(String title) async {
    final response = await post(
      Uri.parse(
          'https://musicappbackendnischal-production.up.railway.app/api=music_upload/get/'),
      body: jsonEncode({
        "title": title,
      }),
    );
  ...
  static Future<String?> getAllMusic() async {
    final response = await get(Uri.parse(
        'https://musicappbackendnischal-production.up.railway.app/api=music_upload/get_all/'));
    if (response.statusCode >= 400) return null;
  ...
  static Future<List?> getNotifications() async {
    final response = await get(Uri.parse(
        'https://musicappbackendnischal-production.up.railway.app/api=notifications/get/'));
    if (response.statusCode == 401) return null;
  ...
  static Future<String?> uploadMusic(
    ...
    final request = MultipartRequest(
      'POST',
      Uri.parse(
          'https://musicappbackendnischal-production.up.railway.app/api=music_upload/'),
    );
    request.files.add(
  ...
  static Future<void> requestMusic(
    ...
    await post(
        Uri.parse(
            'https://musicappbackendnischal-production.up.railway.app/api=request_music/'),
  ...
  static Future<List<String>?> deleteMusic(
    ...
    final response = await delete(
        Uri.parse(
            'https://musicappbackendnischal-production.up.railway.app/api=music_upload/delete/'),
